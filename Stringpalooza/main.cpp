 ...
 * Each of the following lines should crash the program by failing an asert.
...
//    printf("crashing with utstrrev\n\n\n"); utstrrev(utstr1); //assertion failed
//    printf("Crashing with utstrcpy\n\n\n"); utstrcpy(utstr1, p); //assertion failed
//    printf("crashing with utstrcat\n\n\n"); utstrcat(utstr1, p); //assertion failed
//    printf("crashing with utstrfree\n\n\n"); utstrfree(utstr1); //assertion failed
//    printf("crashing with utstrrealloc\n\n\n"); utstrrealloc(utstr1, 40); //assertion failed
    free(utstr1->string);
    free(utstr1);
}
