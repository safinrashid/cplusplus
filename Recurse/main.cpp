...
int main(void) {
    ...
    /* test min */
    int a[] = { 1, 10, 2, 3, 6, 4, 8, 9, 0, 7, 5};
    printf("the largest of the first 10 natural numbers is: %d\n", maxRec1(a, 10));
    printf("the largest of the first 10 natural numbers is: %d\n", maxRec2(a, 6));
    a[3] = 11;
    printf("now the largest is: %d\n", maxRec1(a, 10));
    printf("now the largest is: %d\n", maxRec2(a, 6));
    ...
    s1 = "C++ programming"; s2 = "c programming";
    ...
    s1 = "//**apple**//"; s2 = "apple";
    if (strCompare2(s1, s2) == 0) {
        printf("\"%s\" is equal than \"%s\", very good\n", s1, s2);
    } else {
        printf("oops, \"%s\" should be equal than \"%s\"\n", s1, s2);
    }
    ...
    change4 = change(51, 5, 12);
    printf("change 5 should be 3d, 3n, 0p and is: %dd %dn %dp\n", change4.dodeks, change4.nicks, change4.pennies);
}
