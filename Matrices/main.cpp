...
void testCreateSubMatrixA(void) {
    double **result;
    double **input_ptr;
    double **expected_ptr;
    ...
    double one_sub_a[1] = {1};
    
    double *expected_a[] = {one_sub_a};
    expected_ptr = expected_a;
    
    printf("Stage 3 testCreateSubMatrixA:...");
    result = createSubMatrix(input_ptr, 2, 2, 1, 1);
    
    if (!assertEqualMatricesPtr(result, expected_ptr, 1, 1)) {
        return;
    }
...
void testCreateSubMatrixB(void) {
    double **result;
    double **input_ptr;
    double **expected_ptr;
    ...
    double one_sub_b[2] = {4, 6};
    double two_sub_b[2] = {7, 9};
    
    double *expected_b[] = {one_sub_b, two_sub_b};
    expected_ptr = expected_b;
    
    printf("Stage 3 testCreateSubMatrixB:...");
    result = createSubMatrix(input_ptr, 3, 3, 0, 1);
...
void testCreateSubMatrixC(void){
    double **result;
    double **input_ptr;
    double **expected_ptr;
    ...
    double one_sub_a[2] = {1, 3};
    
    double *expected_c[] = {one_sub_a};
    expected_ptr = expected_c;
    
    printf("Stage 3 testCreateSubMatrixC:...");
    result = createSubMatrix(input_ptr, 2, 3, 1, 1);
    if (!assertEqualMatricesPtr(result, expected_ptr, 1, 2)) {
        return;
    }
...
void testStage3(void) {
    testCreateSubMatrixA();
    testCreateSubMatrixB();
    testCreateSubMatrixC();
}
...
int main(int argc, char **argv) {
    ...
    for (i = 1; i < argc; i++) {
        if (strcmp("testMultiplyMatrixA", argv[i]) == 0) {
            ...
            testMultiplyMatrixD();
        } else if (strcmp("testCreateSubMatrixA", argv[i]) == 0) {
            testCreateSubMatrixA();
        } else if (strcmp("testCreateSubMatrixB", argv[i]) == 0) {
            testCreateSubMatrixB();
        } else if (strcmp("testCreateSubMatrixC", argv[i]) == 0) {
            testCreateSubMatrixC();
    ...
    if (argc == 1) {
        testStage1();//all test cases pass
        testStage2();//all test cases pass
        testStage3();//all test cases pass
    }
